...
<head>
    ...
    <!-- Bootstrap CSS File -->
    <link href="{{asset("public/theme/regna/lib/bootstrap/css/bootstrap.min.css")}}" rel="stylesheet">

    <!-- Libraries CSS Files -->
    <link href="{{asset("public/theme/regna/lib/font-awesome/css/font-awesome.min.css")}}" rel="stylesheet">
    <link href="{{asset("public/theme/regna/lib/animate/animate.min.css")}}" rel="stylesheet">
    ...
    <script src="{{asset("public/theme/regna/lib/bootstrap/js/bootstrap.bundle.min.js")}}"></script>
    <script src="{{asset("public/theme/regna/lib/easing/easing.min.js")}}"></script>
    <script src="{{asset("public/theme/regna/lib/wow/wow.min.js")}}"></script>

    <script src="{{asset("public/theme/regna/lib/waypoints/waypoints.min.js")}}"></script>
    <script src="{{asset("public/theme/regna/lib/counterup/counterup.min.js")}}"></script>
    <script src="{{asset("public/theme/regna/lib/superfish/hoverIntent.js")}}"></script>
    <script src="{{asset("public/theme/regna/lib/superfish/superfish.min.js")}}"></script>

    <!-- Contact Form JavaScript File -->
    <script src="{{asset("public/theme/regna/contactform/contactform.js")}}"></script>

    <!-- Template Main Javascript File -->
    <script src="{{asset("public/theme/regna/js/main.js")}}"></script>
