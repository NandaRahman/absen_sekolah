            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        @role('admin')
                        <li><a href="{{route('admin.absensi')}}"><i class="fa fa-list-alt fa-fw"></i> Rekap</a></li>
                        <li><a href="{{route('admin.pengumuman')}}"><i class="fa fa-edit fa-fw"></i> Pengumuman</a></li>
                        ...
                        <li><a href="{{route('admin.saran')}}"><i class="fa fa-user fa-fw"></i> Saran</a></li>
                        @endrole
                        @role('user')
                        <li><a href="{{route('user.laporan')}}"><i class="fa fa-edit fa-fw"></i> Rekap</a></li>
